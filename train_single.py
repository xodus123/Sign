...
from src.preprocessing_aug import preprocess_images, get_feature_label  # 증강용으로 돌릴 때만 주석 변경
...
log_path = './logs/train_single_log.csv'  # 모든 실험 한 파일에 누적
